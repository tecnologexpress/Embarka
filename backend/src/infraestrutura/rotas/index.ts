...
import JANELA_COLETA_FORNECEDOR_ROTA from '@/dominios/janela-coleta/rota';
...
export const CONFIGURAR_ROTAS = (prm_app: Express): void => {
    ...
    // Rotas janela de coleta fornecedor
    prm_app.use('/janela-coleta-fornecedor', JANELA_COLETA_FORNECEDOR_ROTA)
