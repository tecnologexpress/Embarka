          ...
          <div className="text-center">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <p className="text-green-800 text-sm">
                <strong>Sistema Integrado:</strong> Logística Inteligente + IA +
                Auditoria + SGA
              </p>
            </div>
        ...
        <div className="flex items-center justify-center w-full px-8 relative z-10">
          <div className="max-w-lg bg-green-700 bg-opacity-10 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <p className="text-green-50 text-lg mb-12 leading-relaxed font-medium">
              ...
              transportadoras com IA, auditoria avançada e gestão ambiental para
              máxima eficiência.
            </p>
            ...
            <div className="mt-16 text-center">
              ...
              <div className="mt-8 grid grid-cols-3 gap-6 text-center">
                <div className="bg-white bg-opacity-15 rounded-lg p-4">
                  ...
                  <p className="text-sm font-bold text-gray-600">27 Estados</p>
